...
m1.MCMC <- jags(data = list(y=y,x=mm1,n=length(y)), inits = init_values, parameters.to.save = params, model.file = "GzLM.jags", n.chains = 3, n.iter = 20000, n.burnin = 2000, n.thin = 10, DIC = F)
...
m1.MCMC <- jags(data = list(f=females,x=mm1,n=length(females),total=pop), inits = init_values, parameters.to.save = params, model.file = "GzLMbinomial.jags", n.chains = 3, n.iter = 20000, n.burnin = 2000, n.thin = 10, DIC = F)
